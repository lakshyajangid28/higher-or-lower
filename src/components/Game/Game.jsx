...
const Game = ({ score, setScore, setCurrentPage }) => {
  ...
  function getRandomNumber() {
    return Math.floor(Math.random() * 1558);
  }
  ...
  function continueGame() {
    ...
    setTimeout(() => {
      ...
      middleButton.current.style.backgroundColor = "rgb(72, 220, 53)";
  ...
  function gameOver() {
    ...
    setTimeout(() => {
      rightValue.current.style.display = "block";
      middleButton.current.style.backgroundColor = "rgb(231, 90, 90)";
      middleButton.current.textContent = "X";
      middleButton.current.style.color = "white";
    }, 750);
    setTimeout(() => {
