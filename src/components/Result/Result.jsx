...
const Result = ({ score, setCurrentPage, setScore }) => {
  ...
  function getMessage(score) {
    ...
    if (score > averageScore + 2) {
      ...
      message = "Nice job! You’re doing better than averag75. Keep it up!";
    } else if (score === averageScore) {
  ...
  function setImage(score) {
    ...
    if (score > averageScore + 2) {
      return `linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url('src/assets/result/5.jpeg') no-repeat center center / cover`;
    } else if (score > averageScore) {
      return `linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url('src/assets/result/4.jpg') no-repeat center center / cover`;
    } else if (score === averageScore) {
      return `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.75)), url('src/assets/result/3.jpg') no-repeat center center / cover`;
    } else if (score > averageScore - 2) {
      return `linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url('src/assets/result/2.jpeg') no-repeat center center / cover`;
    } else {
      return `linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url('src/assets/result/1.jpg') no-repeat center center / cover`;
    }
  }
